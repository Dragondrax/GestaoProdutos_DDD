...
namespace GestaoProdutos.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeDataFabricaoEhMaiorQueDataDeValidade(DateTime dataFabricacao, DateTime dataValidade, string mensagem)
        {
